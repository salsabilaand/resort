                ...
                <div class="row mb_30">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="pengunjung/image/room1.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="pengunjung/image/room2.jpg" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="pengunjung/image/room3.jpg" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="pengunjung/image/room4.jpg" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list_style instafeed d-flex flex-wrap">
                                <li><img src="pengunjung/image/instagram/Image-01.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-02.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-03.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-04.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-05.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-06.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-07.jpg" alt=""></li>
                                <li><img src="pengunjung/image/instagram/Image-08.jpg" alt=""></li>
                            </ul>
                        </div>
                    </div>						
                </div>
