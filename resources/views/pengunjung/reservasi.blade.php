                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item active"><a class="nav-link" href="{{route('tampil-penginapan')}}">Booking Resort</a></li>
        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Booking Resort</h2>
                    <ol class="breadcrumb">
                        <li><a href="#">Reservation</a></li>
                        <li class="active">Booking Resort</li>
                    </ol>
                </div>
            </div>
        </section>
